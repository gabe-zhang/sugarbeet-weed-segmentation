...
class MyDataset(Dataset):
    ...
    def __init__(self, path_to_dataset: str, 
        ...
        # ------------- Prepare Predicting -------------
        self.path_to_predict_images = os.path.join(path_to_dataset, "predict", "images")
        self.filenames_predict = common.get_img_fnames_in_dir(self.path_to_predict_images)
    ...
    def get_predict_item(self, idx: int) -> Dict:
        path_to_current_img = os.path.join(self.path_to_predict_images, self.filenames_predict[idx])
...
class MyDatasetModule(pl.LightningDataModule):
    """ Encapsulates all the steps needed to process data for prediction.
    """
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        Args:
            stage (Optional[str], optional): either 'fit', 'validate', 'test', or 'predict'
        """
    ...
    def predict_dataloader(self) -> DataLoader:
        ...
        loader = DataLoader(self.predict_ds, batch_size=batch_size, num_workers=n_workers, shuffle=False, pin_memory=True)
