...
except Exception:  # for torchvision>=0.4
...
class ResNet(nn.Module):
    def __init__(
        ...
        # branch, so that the residual branch starts with
        # zeros, and each residual block behaves like an
        # identity. This improves the model by 0.2~0.3%
